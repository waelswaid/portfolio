...
async def send_friend_request(to: str, sender_id: str, sender_email: str) -> dict:
...
async def friend_request_accept(requester_id: str, accepter_id: str, accepter_email: str) -> dict:
    async with async_session() as session:
        try:
...
async def friend_request_declined(requester_id: str, decliner_id: str) -> dict:
    async with async_session() as session:
        try:
...
async def friend_remove(removed_id: str, remover_id: str) -> dict:
    async with async_session() as session:
        try:
...
async def return_friend_list(user_id: str) -> dict:
    async with async_session() as session:
        try:
...
async def return_pending_list(user_id: str) -> dict:
    async with async_session() as session:
        try:
